...
namespace Kurs
{
    ...
    public class FileStorageHandler
    {
        ...
        public void SaveDrivers(List<Driver> drivers)
        {
            ...
            var allData = string.Join("----", lines); // Соединяем все строки в одну, разделяя их точкой с запятой
            File.WriteAllText(_driversFilePath, allData); // Записываем в одну строку
        }
        ...
        public void SaveCars(List<Car> cars)
        {
            ...
            var allData = string.Join("----", lines); // Все машины в одной строке, разделенные точкой с запятой
            File.WriteAllText(_carsFilePath, allData); // Записать все в одну строку
        }
        ...
        public void SaveTaxiParks(List<TaxiPark> taxiParks)
        {
            ...
            var allData = string.Join("-----", lines); // Соединяем все строки в одну
            File.WriteAllText(_taxiParkFilePath, allData); // Записываем в одну строку
        }
